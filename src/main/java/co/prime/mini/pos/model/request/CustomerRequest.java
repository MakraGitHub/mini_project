...
public class CustomerRequest {
    ...
    @Length(min = 4, max = 200, message = "Customer Local name between 4 to 70 characters")
    private String customerLocalName;

    @NotBlank(message = "Customer English name is required!")
    @Length(min = 4, max = 250, message = "Customer english name between 8 to 200 characters")
